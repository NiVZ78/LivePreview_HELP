    ...
    for(var i=0; i<pixelData.length; i+=4) {
      ...
      for (var key in originalColor){
        ...
        if (originalColor[key] == pixelColor){
          ...
          /*  ORIGINAL VERSION - COMMENTED OUT TO TRY AND GET SUNNY COLOR
          ...
          */
          ...
          //sunny = 0x000000 || sunny;
          //sunny = GColor.toSunnyHex(sunny.toString(16));
                  
          /* Console.log seems to stop the APP CONFIG loading altogether */
          // console.log(sunny);
